...
if (!isset($_SESSION["Username"])) {
    echo "<script>alert('Maaf anda harus login terlebih dahulu!'); window.location=('form_login.php');</script>";
	exit;
}
?>
<?php
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                    ...
                    <input type="checkbox" class="btn-check" id="btncheck1" autocomplete="off">
                    <label class="btn btn-outline-primary" for="btncheck1"><a href="logout.php">Log Out</a></label>
                </div>
            </div>
        </div>
    </div>
